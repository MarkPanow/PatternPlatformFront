...
export default class PatternA extends Vue {
  ...
  private id = 3
  private patternName = 'Pattern C'
  private principle = 'Pattern C Principle'
  private problem = 'Pattern C Problem'
  private situation = 'Pattern C Situation'
  private solution = 'Pattern C Solution'
  private implDetails = 'Pattern C Implementation Details'
  private img = require('@/assets/patternImg/patternC.webp')
