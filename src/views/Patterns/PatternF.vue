...
export default class PatternA extends Vue {
  ...
  private id = 6
  private patternName = 'Pattern F'
  private principle = 'Pattern F Principle'
  private problem = 'Pattern F Problem'
  private situation = 'Pattern F Situation'
  private solution = 'Pattern F Solution'
  private implDetails = 'Pattern F Implementation Details'
  private img = require('@/assets/patternImg/patternF.webp')
