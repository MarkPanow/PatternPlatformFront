...
export default class PatternA extends Vue {
  ...
  private id = 4
  private patternName = 'Pattern D'
  private principle = 'Pattern D Principle'
  private problem = 'Pattern D Problem'
  private situation = 'Pattern D Situation'
  private solution = 'Pattern D Solution'
  private implDetails = 'Pattern D Implementation Details'
  private img = require('@/assets/patternImg/patternD.webp')
  private relatedPattern = [
    ...
    },
    {
      name: "Pattern E",
      relationship: "similar",
      href: "/patterns/pattern-E"
    },
    {
      name: "Pattern A",
      relationship: "combination",
      href: "/patterns/pattern-a"
    },
    {
      name: "Pattern B",
      relationship: "combination",
