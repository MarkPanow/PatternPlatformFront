...
export default class PatternA extends Vue {
  ...
  private id = 2
  private patternName = 'Pattern B'
  private principle = 'Pattern B Principle'
  private problem = 'Pattern B Problem'
  private situation = 'Pattern B Situation'
  private solution = 'Pattern B Solution'
  private implDetails = 'Pattern B Implementation Details'
  private img = require('@/assets/patternImg/patternB.webp')
