      ...
      <div class="card">
        <div class="card-content">
          ...
          <b-field grouped group-multiline>
            ...
            <div class="ml-2">({{ this.numberRatings }})</div>
          </b-field>
...
export default class PatternA extends Vue {
  ...
  private id = 1
  private patternName = 'Pattern A'
  private principle = 'Pattern A Principle'
  private problem = 'Lorem dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum'
  private situation = 'Dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum'
  private solution = 'Wuis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum'
  private implDetails = 'Sed pulvinar ut arcu et efficitur. Maecenas efficitur, odio vitae semper tempus, velit ligula lacinia ante, ultricies facilisis libero risus et massa. Cras quis lobortis magna. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aliquam vel massa et ligula euismod iaculis. Aenean eleifend mauris in risus tempus, eget interdum turpis porta. Aliquam erat volutpat'
  private img = require('@/assets/patternImg/patternA.webp')
