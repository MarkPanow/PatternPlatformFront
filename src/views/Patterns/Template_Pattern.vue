...
export default class PatternA extends Vue {
  ...
  private id = -1 //  must match patternId
  private patternName = 'Template Name'
  private principle = 'Template Principle'
  private problem ='Template Problem'
  private situation = 'Template Situation'
  private solution = 'Template Solution'
  private implDetails = 'Template Implementation Details'
  private img = require('@/assets/patternImg/TemplateImg.webp') // path to template img
  private relatedPattern = [
    // use | similar | combination
    {
      name: "Pattern C", // displayed name of related pattern
      relationship: "use", // type of relationship
      href: "/patterns/pattern-c" // link to page
    },
    {
      name: "Pattern F",
